...
|Drug2cell analysis with scDECAF| [Running scDECAF with pre-computed Drug2cell scores in HECOA Organoid Atlas](https://github.com/DavisLaboratory/scDECAF-reproducibility/blob/master/Drug2Cell/scDECAF_Drug2Cell_workflow_ismb2025.ipynb)|
